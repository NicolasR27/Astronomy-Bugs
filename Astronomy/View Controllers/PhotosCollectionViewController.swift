...
class PhotosCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @IBAction func goToNextSol(_ sender: Any?) {
        ...
        guard let currentDescription = solDescription, let index = solDescriptions.firstIndex(of: currentDescription),index < solDescriptions.count - 1 else{
    ...
    func collectionView(_ collectionView: UICollectionView, didEndDisplaying cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        //ToDo: go through all reference of photoreferences ,and check why this may be occuring
