        ...
        PHPhotoLibrary.requestAuthorization{ (status) in
            ...
            default:
                DispatchQueue.main.async{
                    let alert = UIAlertController(title:"Could not save image", message:"Astronomy does not have access to your Photo libarary.Please change this in Settings if you would like to save images.",preferredStyle:.alert)
